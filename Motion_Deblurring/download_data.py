...
### Google drive IDs ######
GoPro_train = '1FsxWHZTzVrb2hxWvUVGJb_3huoh4YSrb'      ## https://drive.google.com/file/d/1zgALzrLCC_tcXKu_iHQTHukKUVT1aodI/view?usp=sharing
GoPro_test  = '12Mi4uQrKwMhy59cnsfFtMarQA8RRxGDQ'      ## https://drive.google.com/file/d/1k6DTSHu4saUgrGTYkkZXTptILyG9RRll/view?usp=sharing
...
for data in args.data.split('-'):
    if data == 'train':
        ...
        os.system(f'gdown {GoPro_train} -O Datasets/Downloads/')
    ...
    if data == 'test':
        if dataset == 'all' or dataset == 'GoPro':
            ...
            os.system(f'gdown {GoPro_test} -O Datasets/')
            print('Extracting GoPro Data...')
        ...
        if dataset == 'all' or dataset == 'HIDE':
            ...
            os.system(f'gdown {HIDE_test} -O Datasets/')
        ...
        if dataset == 'all' or dataset == 'RealBlur_R':
            ...
            os.system(f'gdown {RealBlurR_test} -O Datasets/')
        ...
        if dataset == 'all' or dataset == 'RealBlur_J':
            ...
            os.system(f'gdown {RealBlurJ_test} -O Datasets/')
